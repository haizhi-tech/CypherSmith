...
impl RandomGenerator {
    pub fn new() -> RandomGenerator {
        RandomGenerator {
            rng: thread_rng(),
            uniform_d6: Uniform::new(1, 6),
            uniform_d9: Uniform::new(1, 9),
            uniform_d12: Uniform::new(1, 12),
            uniform_d20: Uniform::new(1, 20),
            uniform_d42: Uniform::new(1, 42),
            uniform_d100: Uniform::new(1, 100),
        }
    }
